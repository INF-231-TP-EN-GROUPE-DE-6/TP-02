...
int main() {
    // Créer liste doublement chaînée triée: 1 <-> 3 <-> 5 <-> 7
    ...
    n1->data = 1; n1->next = n2; n1->prev = NULL;
    n2->data = 3; n2->next = n3; n2->prev = n1;
    n3->data = 5; n3->next = n4; n3->prev = n2;
    n4->data = 7; n4->next = NULL; n4->prev = n3;
